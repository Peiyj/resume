  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem{AI-Powered Curation Platform}
        {Designed and built an AI-powered content curation platform using OpenAI GPT-4.1 with multimodal prompt engineering, structured output parsing, and production-grade LLM service integration for enterprise learning program creation.}
    \resumeItemListEnd

...
export const translations = {
  en: {
    ...
    courseraSeniorBullet5: "Designed and built an AI-powered content curation platform using OpenAI GPT-4.1 with multimodal prompt engineering, structured output parsing, and production-grade LLM service integration for enterprise learning program creation",
  ...
  zh: {
    ...
    courseraSeniorBullet5: "设计并构建了AI驱动的内容策展平台，使用OpenAI GPT-4.1进行多模态提示工程、结构化输出解析和生产级LLM服务集成，用于企业学习项目创建",
